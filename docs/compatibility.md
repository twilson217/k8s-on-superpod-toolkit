...
|-------------|-----------|-------------|------------|--------------|-------------|--------|----------|-------|
| **kube-prometheus-stack** | prometheus | 70.3.0 (app: v0.81.0) | 78.5.0 (app: v0.86.1) | ✅ Yes (1.19+) | ✅ Yes (1.19+) | ⏸️ Optional upgrade | P2 | **Current: Chart 70.3.0 with Prometheus Operator v0.81.0 (Dec 2024) specifies K8s 1.19+ minimum (compatible with 1.31, 1.32, 1.33). Target: Chart 78.5.0 with Operator v0.86.1 (Oct 2025) specifies K8s 1.19+ with latest features.** Both chart versions fully compatible. **Chart 78.5.0 includes Prometheus v3.2.1, Alertmanager v0.28.1, Grafana 11.5.2.** Chart repo: https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack / Releases: https://artifacthub.io/packages/helm/prometheus-community/kube-prometheus-stack |
| **metrics-server** | kube-system | 3.12.2 (app: v0.7.2) | 3.13.0 (app: v0.8.0) | ✅ Yes (1.27+) | ✅ Yes (1.29+) | ⏸️ Optional upgrade | P3 | **Current v0.7.2 supports K8s 1.27+ (compatible with 1.31, 1.32, 1.33). Target v0.8.0 adds enhanced features and supports K8s 1.29+.** Both versions fully compatible. Upgrade optional for new features. Docs: https://github.com/kubernetes-sigs/metrics-server |
| **kube-state-metrics** | kube-system | 5.31.0 (app: v2.15.0) | 6.3.0 (app: v2.17.0) | ⚠️ Works but not optimal | ✅ Yes | 🔄 **Upgrade to v2.17.0** | **P1 - HIGH** | **Current v2.15.0 uses client-go v1.32 (works with K8s 1.31 but not optimal for 1.33). Target v2.17.0 uses client-go v1.33 (proper match).** Upgrade before K8s 1.33 for optimal compatibility. Matrix: v2.15→K8s 1.32, v2.17→K8s 1.33. Docs: https://github.com/kubernetes/kube-state-metrics |
